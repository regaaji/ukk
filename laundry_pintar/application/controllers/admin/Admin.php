...
class Admin extends CI_Controller
{
    ...
    {
        $this->load->view('admin/admin/njajal');
    }
     ...
     public function tambahtransaksi()
    {
        ...
        $this->load->view('admin/templates/header', $data);
        $this->load->view('admin/templates/sidebar', $data);
        $this->load->view('admin/admin/tambahtransaksi', $data);
        $this->load->view('admin/templates/footer', $data);
        } else {
            //$data = [
    ...
    public function detailtransaksi($transaksi_id)
    {
        ...
        $this->load->view('admin/templates/header', $data);
        $this->load->view('admin/templates/sidebar', $data);
        $this->load->view('admin/admin/detailtransaksi', $data);
        $this->load->view('admin/templates/footer', $data);
        } else {
    ...
    public function riwayattransaksi()
    {
        ...
        $this->load->view('admin/templates/header', $data);
        $this->load->view('admin/templates/sidebar', $data);
        $this->load->view('admin/admin/riwayattransaksi', $data);
        $this->load->view('admin/templates/footer', $data);
