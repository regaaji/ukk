   ...
   <div class="row wow fadeIn">
    ...
    <div class="col-md-12 mb-4">
      ...
      <div class="card shadow">
        ...
        <div class="card-header blue-gradient white-text"><i class="fas fa-list pr-2"></i>Tambah Member Laundry</div>
        ...
        <div class="card-body">
          ...
          <form action="" method="post" style="margin-top: -20px;">
            ...
            <a href="<?= base_url('kasir/member/') ?>" class="btn btn-sm ripe-malinka-gradient text-white">Batal</a>
          </form>
