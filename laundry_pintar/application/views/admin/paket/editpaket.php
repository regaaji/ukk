    ...
    <div class="container-fluid mt-5">
      ...
      <!-- /.row -->
        ...
        <div class="col-md-12 mb-4">
          ...
          <div class="card-header blue-gradient white-text"><i class="fas fa-list pr-1"></i>Edit Paket Laundry</div>
            ...
            <div class="card-body">
              ...
              <form action="" method="post">
               ...
               <div class="form-group">
                ...
                <select name="jenis" id="" class="form-control">
                  <option value="kiloan" <?php if($edit['jenis'] == 'kiloan'){ echo 'selected'; } ?>>Kiloan</option>
                  <option value="selimut" <?php if($edit['jenis'] == 'selimut'){ echo 'selected'; } ?>>Selimut</option>
                  <option value="bed_cover" <?php if($edit['jenis'] == 'bed_cover'){ echo 'selected'; } ?>>Bed Cover</option>
                  <option value="kaos" <?php if($edit['jenis'] == 'kaos'){ echo 'selected'; } ?>>Kaos</option>
                  <option value="lain" <?php if($edit['jenis'] == 'lain'){ echo 'selected'; } ?>>Lain</option>
                </select>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_paket" value="<?= $edit['nama_paket']; ?>">
                <small id="" class="form-text text-danger"><?= form_error('nama_paket'); ?></small>
              </div>

              <div class="form-group">
                <label for="">Harga</label>
                <input type="text" class="form-control" name="harga" value="<?= $edit['harga'] ?>" onkeypress="return isNumber(event)">
