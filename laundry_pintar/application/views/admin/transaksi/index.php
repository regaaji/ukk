        ...
        <div class="col-md-12 mb-4">
          ...
          <div class="card shadow">
           ...
           <div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash') ?>">
            ...
            <!--Card content-->
            <div class="card-body">
              <a href="<?= base_url('admin/admin/') ?>tambahtransaksi" class="btn blue-gradient btn-sm">Tambah Transaksi</a>
              <br><br>
                  ...
                  <table class="table table-hover table-bordered" id="tabel1">
                    ...
                    <?php foreach($ambil->result_array() as $pecah) : ?>
                            <tr>
                              ...
                              <td>
                                 <a href="<?= base_url('admin/admin/') ?>detailtransaksi/<?= $pecah['transaksi_id']; ?>" class="btn sunny-morning-gradient btn-sm"><i class="fas fa-info-circle text-white"></i></a>
                                 <br><br>
